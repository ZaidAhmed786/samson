            ...
            <div className="about-us-info-wrap">
              ...
              <div className="ltn__feature-item ltn__feature-item-3">
                ...
                <div className="ltn__feature-info">
                  ...
                  <p>
                    In the realm of Samson Properties, React state is the brushstroke, painting vibrant tales of user engagement. 
                    Each pixel pulsates with the heartbeat of innovation
                  </p>
                </div>
              </div>
              <div className="ltn__feature-item ltn__feature-item-3">
